...
thu = Customer("Minh Thu", "29/03/1999", "thu.bui1@onemount.com", "0912121211")

my_account = SavingAccount("19001199", thu, 2_500_000)
my_account.display()
print("Số tiền tiết kiệm:",my_account.calculate_interest(),"vnđ")